...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_todolist_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/todolist.js */ \"./src/modules/todolist.js\");\n\n\n\nclass Todo {\n  constructor(description, completed, index) {\n    this.description = description;\n    this.completed = completed;\n    this.index = index;\n  }\n}\n\ndocument.addEventListener('DOMContentLoaded', _modules_todolist_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].checkStatus, _modules_todolist_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].displayTodos());\n\nconst form = document.querySelector('.toDoForm');\nform.addEventListener('submit', (e) => {\n  e.preventDefault();\n  const description = document.querySelector('.description');\n  const todo = new Todo(description.value, false, _modules_todolist_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getTodos().length);\n  _modules_todolist_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].addTodo(todo);\n  _modules_todolist_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].displayTodo(todo);\n  form.reset();\n});\n\nconst clear = document.querySelector('.clear-completed');\nclear.addEventListener('click', () => {\n  _modules_todolist_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].clearCompleted();\n});\n\n\n//# sourceURL=webpack://todolist/./src/index.js?");
